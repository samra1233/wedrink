...
export const regions: Region[] = [
  ...
  },
  {
    ...
    name: 'Lahore',
     accountDetails: {
     bankName: 'JS Bank',
     accountTitle: 'Wedrink supply chain (SMC-PVT)Limited ',
     iban: 'PK07JSBL9557000002750554'
        },
    franchises: [
  ...
  },
  {
    ...
    franchises: [
      { id: 'f-gjt-1', name: 'Gujrat Gymkhana', city: 'Gujrat' },
        { id: 'f-gjt-2', name: 'Wazirabad Road', city: 'Sialkot' },
          { id: 'f-gjt-3', name: 'Sialkot Bypass (Canal Sq)', city: 'Gujranwala' },
      { id: 'f-gjt-4', name: 'Satellite Town (Hafiz Mall)', city: 'Gujranwala' },
      { id: 'f-gjt-5', name: 'Fazal Centre Rahwali', city: 'Gujranwala' },
      { id: 'f-gjt-6', name: 'Old GT Road', city: 'Jhelum' },
       //{ id: 'f-gjt-7', name: 'Wazirabad Road', city: 'Sialkot' },
      { id: 'f-gjt-8', name: 'Madhrian Wala Road', city: 'Hafizabad' },
      { id: 'f-gjt-9', name: 'Mandi Bahauddin Phalia Road', city: 'Mandi Bahauddin' },
        { id: 'f-gjt-10', name: 'Gulshan Colony', city: 'Wazirabad' },
    ]
  },
  {
    id: 'reg-qta',
  ...
  },
  {
    ...
    franchises: [
      { id: 'f-kpk-1', name: 'Shami Road', city: 'Peshawar' },
      { id: 'f-kpk-2', name: 'Ring Road (HBK Arena)', city: 'Peshawar' },
      { id: 'f-kpk-3', name: 'University Road', city: 'Peshawar' },
       { id: 'f-kpk-4', name: 'Nowshera Road', city: 'Mardan' },
  ...
  },
  {
    ...
    franchises: [
      ...
      { id: 'f-mul-3', name: 'Bosan Road Gulghast Town', city: 'Multan' },
       { id: 'f-mul-4', name: 'Lyallpur Galleria', city: 'Faisalabad' },
        { id: 'f-mul-5', name: 'Gulberg Road', city: 'Faisalabad' },
       { id: 'f-mul-6', name: 'Model Town A (Orion Tower)', city: 'Bahawalpur' },
